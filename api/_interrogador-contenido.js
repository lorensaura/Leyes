...
Marco general de la responsabilidad contractual

Concepto de responsabilidad civil y de responsabilidad contractual

Los estatutos de responsabilidad y la regla general (arts. 1437 y 2284)

Sentido restringido y amplio. Los «efectos de las obligaciones»

El sistema de acciones o «remedios» del art. 1489

Sistema de atribución: responsabilidad subjetiva y objetivación

El incumplimiento contractual

Concepto y clases de incumplimiento (art. 1556)

Incumplimientos que no generan responsabilidad
...
Nociones generales y concepto

¿Es el «derecho principal» del acreedor?

Objeto: cumplimiento en naturaleza y por equivalencia

Presupuestos de procedencia

Cumplimiento y ejecución forzada de obligaciones de dar, hacer y no hacer

Límites a la acción de cumplimiento: la imposibilidad

La resolución por incumplimiento

Generalidades y nomenclatura

La condición resolutoria tácita: concepto y fundamento
...
Enervar la acción mediante el pago

El art. 1552 y la excepción de contrato no cumplido

Efectos de la resolución

Resolución, nulidad y resciliación

El pacto comisorio

La cláusula de término unilateral
...
¿Es la indemnización un remedio autónomo?

Primer requisito: incumplimiento imputable (dolo y culpa)

Segundo requisito: el perjuicio (concepto, requisitos y clases)

Tercer requisito: la relación de causalidad

Cuarto requisito: la mora del deudor

Avaluación judicial de los perjuicios

Avaluación legal (art. 1559)

Avaluación convencional: la cláusula penal
...
El derecho de prenda general y su fundamento
...
Reglas de interpretación de estas cláusulas

Análisis de determinadas cláusulas de estilo
...
Jurisprudencia — Noción de responsabilidad
...
Por otro lado, en su afán de proteger al acreedor, la ley le otorga ciertos derechos destinados a la conservación del patrimonio del deudor, en razón de que será en ese patrimonio donde se hará exigible el cumplimiento, en virtud del derecho de prenda general del artículo 2465. Son los derechos auxiliares (beneficio de separación, acción subrogatoria, acción pauliana, medidas conservativas), que se estudian en la Sección 7. Conviene tener presente, por último, que el incumplimiento de las obligaciones naturales no produce estos efectos, pues su característica es justamente no otorgar acción para exigir su cumplimiento (art. 1470).
...
Pausa — Comprensión lectora
Has terminado la Sección 2 — El incumplimiento contractual. Entra a la plataforma Digesto y responde las preguntas de comprensión lectora de esta sección. Si alguna se te resiste, vuelve sobre el apartado antes de seguir.
...
El propio Código de Procedimiento Civil asimila ambas clases de cumplimiento: su artículo 438 señala que la ejecución puede recaer «1.º Sobre la especie o cuerpo cierto que se deba y que exista en poder del deudor; 2.º Sobre el valor de la especie debida y que no exista en poder del deudor». La relevancia de entender que el cumplimiento por equivalencia es propiamente cumplimiento —y no indemnización— es enorme: para su procedencia no se requiere dolo o culpa del deudor, sino que basta que objetivamente la obligación se haya incumplido. Como dice Peñailillo, el régimen del cumplimiento por equivalencia es el mismo del cumplimiento en especie: se trata de que el deudor pague lo que la prestación «vale».
...
El inciso final del artículo 1555 agrega que «el acreedor quedará de todos modos indemne»: cualquiera sea la solución que se dé a la infracción, el acreedor ha de quedar libre de daño; aun obteniendo la destrucción o la prestación equivalente, podrá reclamar además los perjuicios moratorios que el incumplimiento le hubiere causado.

Ejemplo — Tres deudores que no cumplen

Dar: A debe entregar un automóvil individualizado y consta la deuda en escritura pública; el acreedor, con ese título ejecutivo, demanda ejecutivamente, embarga y obtiene la entrega o su valor. Hacer: B, maestro, se obligó a pintar la fachada y no lo hace; el acreedor pide que se le autorice a contratar a otro pintor a expensas de B (art. 1553 N.º 2), presenta presupuesto y, si B no consigna, le embarga bienes (art. 541 CPC). No hacer: C se obligó a no levantar un muro que tapa la vista y lo construye; si el muro frustra el fin del contrato, el acreedor pide que se demuela a expensas de C (art. 1555 inc. 2.º), aplicándose por remisión (art. 544 CPC) las reglas del hacer.
...
La norma dispone: «En los contratos bilaterales va envuelta la condición resolutoria de no cumplirse por uno de los contratantes lo pactado. Pero en tal caso podrá el otro contratante pedir a su arbitrio o la resolución o el cumplimiento del contrato, con indemnización de perjuicios». Inspirada en el artículo 1184 del Code francés, regula lo que la doctrina tradicional denomina la «condición resolutoria tácita», entendida como el hecho futuro e incierto consistente en el incumplimiento de alguna de las obligaciones generadas por un contrato bilateral.
...
Es personal. En Chile la unanimidad de la doctrina (Alessandri, Abeliuk, Somarriva) así lo entiende: deriva del contrato, y los contratos generan derechos personales (art. 578: de los derechos personales nacen las acciones personales). Por ser personal, sólo puede entablarse contra quien celebró el contrato, no contra terceros. Si el comprador enajena la cosa a un tercero, no podrá intentarse contra éste la acción resolutoria —sin perjuicio de que exista contra el tercero otra acción (reivindicatoria o restitutoria), según los arts. 1490 y 1491—.
...
Jurisprudencia — CS, 25 de mayo de 2011 (sentido del art. 310 CPC)
...
El pacto comisorio está tratado en el párrafo 10 del Título XXIII del Libro IV, a propósito de la compraventa y por el incumplimiento de la obligación de pagar el precio. Su concepto lo da el artículo 1877: «por el pacto comisorio se estipula expresamente que, no pagándose el precio al tiempo convenido, se resolverá el contrato de compraventa» (inc. 1.º); «entiéndese siempre esta estipulación en el contrato de venta, y cuando se expresa, toma el nombre de pacto comisorio» (inc. 2.º). De allí se desprende que el pacto comisorio no es más que la condición resolutoria tácita expresada, por el no pago del precio en la compraventa: si las partes nada hubieran dicho y el comprador no pagara, el efecto sería en principio el mismo.
...
(2) Pacto comisorio atípico —el convenido para contratos distintos de la compraventa, o en ésta por una obligación distinta del pago del precio—:
...
El artículo 1880 dispone que «el pacto comisorio prescribe al plazo prefijado por las partes, si no pasare de cuatro años, contados desde la fecha del contrato», y que «transcurridos estos cuatro años, prescribe necesariamente, sea que se haya estipulado un plazo más largo o ninguno». Importa precisar: (a) esta regla rige únicamente para el pacto comisorio —simple o calificado— de la compraventa por no pago del precio; el pacto comisorio de otros contratos, o de la compraventa por otra obligación, se rige por las reglas generales de los arts. 2514 inc. 2.º y 2515 (5 años desde que la obligación se hace exigible); (b) el art. 1880 no fija un plazo de 4 años, sino el que acuerden las partes si no pasare de 4 años, de modo que puede ser menor; y (c) contiene una grave anomalía: la prescripción se cuenta desde la fecha del contrato y no desde que la obligación se hace exigible, de suerte que la acción puede estar prescrita antes de nacer —si en una compraventa se conceden 5 años para pagar el precio y se pacta comisorio, a los 5 años la acción comisoria ya habrá prescrito por haber transcurrido 4 desde el contrato—. Esto último ha sido debatido, pues se sostiene que el acreedor conservaría la acción del art. 1873 (la condición resolutoria tácita), regida por sus propios plazos.
...
La indemnización de perjuicios es, de todos los efectos del incumplimiento, el que mayor desarrollo doctrinal y jurisprudencial ha alcanzado, y constituye —junto con la ejecución forzada y la resolución— uno de los pilares del derecho de la responsabilidad contractual. Mientras la ejecución forzada persigue la prestación en naturaleza y la resolución desliga al acreedor del vínculo, la indemnización mira a un objetivo distinto: reparar el daño que el incumplimiento ha causado en el patrimonio o en la persona del acreedor. Por eso suele decirse que es el remedio que, sin restituir lo debido in natura, procura colocar al acreedor en la situación patrimonial equivalente a aquélla en que se hallaría si la obligación se hubiese cumplido oportuna e íntegramente.
...
La doctrina moderna —cuyos exponentes en Chile son, entre otros, Álvaro Vidal, Carlos Pizarro y la corriente que se inspira en el derecho uniforme (Convención de Viena sobre compraventa internacional de mercaderías, Principios UNIDROIT, Principios de Derecho Europeo de los Contratos)— sostiene, por el contrario, que la indemnización es un remedio autónomo que el acreedor puede ejercer con independencia de la resolución o del cumplimiento. Boetsch distingue, dentro de esta corriente, dos vertientes argumentativas:
...
La Corte Suprema ha transitado desde una posición tradicional hacia una creciente apertura a la autonomía, aunque sin una línea del todo uniforme. Conviene conocer los fallos que Boetsch y Orrego citan como hitos:
...
Para que el acreedor tenga derecho a la indemnización de perjuicios no basta el solo incumplimiento: la doctrina exige la concurrencia copulativa de varios requisitos. Orrego, siguiendo a Alessandri, los enumera del siguiente modo: (1) que haya incumplimiento de la obligación; (2) que el incumplimiento sea imputable al deudor, esto es, que provenga de su dolo o de su culpa; (3) que el deudor esté en mora; (4) que el incumplimiento haya causado perjuicios al acreedor; (5) que entre el incumplimiento y los perjuicios exista una relación de causalidad; y (6) que no concurra una causal de exención de responsabilidad. Los subsecciones siguientes desarrollan cada uno de los requisitos sustantivos —imputabilidad, perjuicio, causalidad y mora—; las causales de exención se tratan separadamente en la Sección 6. Comenzamos por la imputabilidad, que es la condición que transforma un mero incumplimiento objetivo en un incumplimiento generador de responsabilidad.
...
(a) El dolo no se presume; debe probarse (art. 1459). «El dolo no se presume sino en los casos especialmente previstos por la ley. En los demás debe probarse». Quien alega que el incumplimiento fue doloso —el acreedor— soporta la carga de acreditarlo, lo que en la práctica es difícil por tratarse de un elemento interno. Esta es una diferencia esencial con la culpa, que sí se presume en sede contractual.
...
El daño directo es el que constituye consecuencia inmediata y necesaria del incumplimiento; el daño indirecto es el que se sigue del incumplimiento sólo de un modo remoto o mediato, a través de una cadena de causas en la que intervienen otros factores. El artículo 1558 consagra la regla esencial: los daños indirectos no se indemnizan nunca, ni siquiera mediando dolo. La razón es de causalidad: el daño indirecto no puede atribuirse jurídicamente al incumplimiento, porque entre uno y otro se interponen causas independientes.
...
(1) Real y virtual. Ya explicado: el daño real es la pérdida efectiva (≈ daño emergente); el virtual, la ventaja que sólo potencialmente integraba el patrimonio (≈ lucro cesante). Es la distinción matriz del pensamiento de Grez y la que le permite sostener su tesis sobre el daño moral.
...
La Corte de Apelaciones de Concepción admitió la reparación del daño moral contractual y se pronunció sobre su prueba y avaluación, inscribiéndose en la línea que, a partir de los años noventa, consolidó la indemnizabilidad del daño moral derivado del incumplimiento. Grez la emplea para ilustrar el tratamiento práctico del rubro por los tribunales de alzada.
...
El punto más espinoso es la avaluación del daño moral, pues no existe un parámetro objetivo de equivalencia entre dinero y dolor. Grez sistematiza seis doctrinas o criterios que se han propuesto para fijar el quantum:

(1) Doctrina que niega la reparación: sostiene que el daño moral no es avaluable y que repararlo importa un enriquecimiento sin causa o una indebida «comercialización» del dolor. Es la posición clásica, hoy abandonada.
...
Grez añade una observación que suele pasar inadvertida: en ciertos regímenes de responsabilidad objetiva el propio legislador ha reconocido y tarifado el daño moral, lo que confirma su indemnizabilidad y ofrece un parámetro legal de avaluación. El ejemplo paradigmático es el Código Aeronáutico, cuyos artículos 144, 148 y 172 establecen un sistema de responsabilidad objetiva del transportador aéreo por muerte o lesiones de los pasajeros, con límites cuantitativos (expresados en unidades de fomento) que comprenden tanto el daño patrimonial como el extrapatrimonial. La existencia de estos baremos legales demuestra que el ordenamiento no sólo admite el daño moral, sino que en ámbitos de riesgo lo predetermina, acogiendo —en la clasificación antes vista— la doctrina de los parámetros objetivos.
...
Jurisprudencia — CS «Alpes Chemie S.A. con CENABAST» (pérdida de chance, principios de 2025)
...
(2) Corresponde únicamente a indemnización moratoria. Como el objeto de la obligación ya es dinero, no cabe «compensar» el dinero con dinero: lo único que procede es indemnizar el retardo, lo que se hace agregando al capital los intereses. De ahí que la avaluación legal sea, por definición, moratoria.

(3) Los perjuicios se presumen. El acreedor que cobra intereses no necesita probar perjuicios (art. 1559 regla 2.ª): basta el retardo para que se devenguen. Es una excepción a la regla general de que el daño debe probarse.
...
Finalmente, se discute si con el pago de los intereses moratorios se agota la indemnización por el retardo en el pago de una suma de dinero. Una posición lo afirma; otra —que Orrego comparte— sostiene que el acreedor puede cobrar una cantidad mayor que la resultante de los intereses, con una salvedad: deberá probar esos perjuicios adicionales, conforme a la regla 2.ª del art. 1559 interpretada a contrario sensu (que dispensa de prueba sólo cuando se cobran intereses).

5.10. Avaluación convencional: la cláusula penal

La avaluación convencional es la que hacen las propias partes, anticipadamente, mediante la cláusula penal. El artículo 1535 la define: «La cláusula penal es aquella en que una persona, para asegurar el cumplimiento de una obligación, se sujeta a una pena, que consiste en dar o hacer algo en caso de no ejecutar o de retardar la obligación principal». Orrego la describe como el pacto en virtud del cual se estipula una prestación a cargo del deudor y en favor del acreedor, representativa de la avaluación anticipada de los perjuicios para el caso de incumplimiento en cualquiera de sus formas. Su gran ventaja es fijar de antemano el monto de los perjuicios, de modo que —por emanar de la voluntad de las partes (art. 1545)— prevalece sobre toda otra liquidación.
...
(1) Función de avaluación anticipada de los perjuicios. Es su función primaria: las partes liquidan por adelantado el daño, evitando la avaluación judicial. De ello deriva una ventaja probatoria decisiva: acreditados la obligación y el incumplimiento, el juez debe condenar al pago de la pena sin que el acreedor pruebe perjuicio alguno, y sin que el deudor pueda alegar que el incumplimiento no le causó daño o le causó uno menor (art. 1542).
...
Dos precisiones jurisprudenciales finales: la rebaja de la pena no puede oponerse como excepción en el juicio ejecutivo (no cabe en el art. 464 del CPC), sino que debe hacerse valer mediante la acción correspondiente —típicamente, reconvención si la acción del acreedor es ordinaria—; y el derecho a pedir la reducción es irrenunciable, porque el art. 1544 «no consulta el interés individual de los deudores sino un objeto de conveniencia pública», de modo que admitir su renuncia frustraría el propósito de la ley.
...
(i) Como circunstancia que impide imputar la infracción al deudor. Ello se traduce en la imposibilidad en que se encuentra el acreedor de exigir indemnización de perjuicios. En este evento, si bien el caso fortuito hace imposible cumplir la obligación, no la extingue, porque se supone que el obstáculo es temporal o transitorio y que, una vez que desaparece, la obligación puede cumplirse, sin que el deudor contraiga responsabilidad por el cumplimiento tardío.
...
Jurisprudencia — Corte Suprema, 11 de marzo de 2025, Rol N.º 217.959-2023 (redacción del abogado integrante Álvaro Vidal Olivares)
...
b) Que el contrato sea oneroso. Ambas partes deben tener interés en el contrato para que pueda hablarse con propiedad de frustración del fin: si sólo lo tiene el acreedor, la pérdida sobrevenida de la utilidad simplemente lo motivará a desestimar el cumplimiento.
...
El inciso 2.º del artículo 2466 añade que los acreedores «podrán asimismo subrogarse en los derechos del deudor como arrendador o arrendatario, según lo dispuesto en los artículos 1965 y 1968». Hay aquí, en realidad, dos hipótesis inversas.
...
La acción pauliana puede intentarse para dejar sin efecto cualquier acto o contrato voluntario del deudor —no los forzados, en los que no se divisa fraude ni voluntad—. Los términos del artículo 2468 son amplios: caben actos unilaterales o bilaterales, gratuitos u onerosos, donaciones, renuncias de derechos, etc. Las cauciones otorgadas por el deudor también quedan incluidas si son fraudulentas; por eso el N.º 1 del artículo 2468 menciona la prenda, la hipoteca y la anticresis. Sería el caso, por ejemplo, de una deuda pendiente que el deudor garantiza con una hipoteca totalmente innecesaria.

b) El perjuicio (requisito objetivo) y los acreedores que pueden accionar

El acreedor que entabla la acción debe tener interés, y sólo lo tiene cuando concurren dos circunstancias: que el deudor sea insolvente o que con el acto aumente su insolvencia, y que su crédito sea anterior al acto que produce la insolvencia. Explica Somarriva que «se entiende que existe este perjuicio cuando a consecuencia del acto el deudor queda en insolvencia, o se aumenta la ya producida»; y agrega que al acreedor que adquiere tal carácter después del acto, éste no puede causarle perjuicio, pues conocía el estado de los negocios del deudor y aceptó contratar en esas condiciones. Orrego precisa dos exigencias respecto de la insolvencia: debe ser contemporánea con el ejercicio de la acción (no son atacables los actos si, pese a la enajenación, el deudor conserva bienes suficientes) y debe provenir, total o parcialmente, del acto que se pretende revocar (nexo causal). Por ello se afirma que la acción pauliana es subsidiaria: el acreedor sólo recurre a ella cuando le es imposible obtener el pago por otros medios. Tampoco pueden atacarse por esta vía los actos que sólo dejen de enriquecer al deudor —que serían materia de acción oblicua— ni los que recaigan sobre bienes inembargables, pues allí no hay perjuicio al derecho de prenda general. Este requisito tiene, pues, carácter objetivo.
...
Jurisprudencia — Corte Suprema, 18 de octubre de 2017, Rol N.º 18.184-2017 (fraude pauliano y solidaridad)
...
Precisamente porque las convenciones que liberan al deudor de responsabilidad son extraordinarias —recuérdese que en materia contractual la culpa se presume (art. 1547 inc. 3.º)—, aunque se aceptan, están sometidas a límites. Fueyo los sistematiza en un célebre octálogo, que conviene tener presente: (1) que no se desmaterialice la esencia del vínculo obligacional; (2) que no se contravenga el orden público, la moral o las buenas costumbres; (3) que no se atente contra el principio general de la buena fe ni haya ejercicio abusivo de los derechos; (4) que no se atente contra la legítima libertad contractual; (5) que no medie en el agente dolo o culpa grave; (6) que no se actúe contra prohibición expresa de la ley; (7) que no se esté en el campo de los derechos irrenunciables; y (8) que no se configure un incumplimiento meramente potestativo y voluntario del deudor.
...
Frecuentísima en los contratos de inspiración anglosajona es la cláusula por la cual el deudor «no responderá de los daños indirectos» (consequential damages). Boetsch no comparte que esta cláusula sea válida desde una lectura puramente exegética del Código, y por buenas razones. Primero, porque el daño indirecto —aquel que no es consecuencia directa e inmediata del incumplimiento— de suyo no se indemniza en nuestro sistema, por faltarle el requisito de la causalidad: el artículo 1558 sólo hace responder de los perjuicios que son consecuencia directa del incumplimiento. Excluir lo que ya está excluido es, en este plano, una cláusula inocua o redundante. Segundo, porque la categoría de los «daños indirectos», tomada del Common Law, es entre nosotros indeterminada e indeterminable con precisión, lo que la hace fuente de incertidumbre. De ahí que, para Boetsch, esta cláusula sólo cobra eficacia y sentido si se la reconduce a la figura de la cláusula penal (art. 1542): las partes son libres de avaluar anticipadamente los perjuicios y de excluir convencionalmente ciertas partidas, pero entonces queda sujeta al control del artículo 1544, que autoriza a reducir la pena enorme. Fuera de ese cauce, la pretendida exclusión de los daños indirectos carece de un asidero dogmático sólido en el Derecho chileno.
...
===== MANUAL: RESPONSABILIDAD EXTRACONTRACTUAL =====
...
Fundamentos, principios y evolución histórica

Diferencias y relación con la responsabilidad penal

Diferencias y relación con la responsabilidad contractual
...
Factores de atribución y antijuridicidad
...
Presunción por el hecho propio (art. 2329)

Presunción por el hecho ajeno (arts. 2320-2322)

Presunción por el hecho de las cosas (arts. 2323-2328)
...
Cúmulo de responsabilidades y de indemnizaciones

La acción de responsabilidad extracontractual

Las acciones que nacen del daño

Legitimación activa: los titulares de la acción

Legitimación pasiva: los obligados a responder

La solidaridad (art. 2317)

Tribunal competente y procedimiento

Extinción de la acción y prescripción
...
Junto al Código Civil, numerosos estatutos legales especiales regulan hipótesis específicas de responsabilidad extracontractual, sometidas frecuentemente a regímenes de responsabilidad objetiva o estricta: la Ley N.° 18.290 (Tránsito), la Ley N.° 16.744 (accidentes del trabajo), la Ley N.° 18.490 (seguro obligatorio), la Ley N.° 19.300 (medio ambiente) y la normativa sobre aeronaves, daños nucleares y derrames de hidrocarburos, entre otras.
...
En el derecho chileno, los principales sistemas de seguro obligatorio son el seguro automotriz obligatorio (Ley N.° 18.490) y el seguro por accidentes del trabajo (Ley N.° 16.744). Ambos operan con independencia del juicio de culpabilidad, garantizando la compensación de la víctima con anterioridad a la determinación de responsabilidades. En presencia de culpa del causante del daño, el asegurador que pagó se subroga legalmente en las acciones que corresponden a la víctima (art. 553 del Código de Comercio), permitiéndole recuperar lo pagado del autor material del daño.
...
En materia civil, en cambio, la ilicitud de la conducta consiste en la infracción a un deber general de cuidado que puede haber sido establecido con anterioridad por la ley —hipótesis de culpa infraccional— o que puede ser determinado por el juez con posterioridad al hecho juzgado. Dado que la conducta humana admite una variedad inabordable de formas, el legislador no puede definir exhaustivamente todos los deberes de cuidado exigibles, de modo que la mayoría de ellos quedan entregados a la apreciación prudencial del tribunal. Esta apertura del sistema civil es lo que permite al derecho de la responsabilidad adaptarse a nuevas situaciones de riesgo sin necesidad de modificación legislativa.
...
Las finalidades de ambos sistemas son esencialmente distintas. La responsabilidad penal persigue sancionar conductas socialmente intolerables mediante la imposición de penas que el Estado aplica en ejercicio del ius puniendi. La responsabilidad civil extracontractual, en cambio, persigue la reparación del daño particular sufrido por la víctima: es una relación bilateral entre el causante del daño y quien lo padece, no entre el Estado y el infractor. De ahí que la indemnización civil se mida por el daño efectivamente sufrido —principio de reparación integral— y no por la gravedad de la conducta ilícita.
...
Incumplimiento de obligación preexistente (2.° grado)
Hecho ilícito sin vínculo previo (1.° grado / originaria)

Prueba de la culpa
Se presume (art. 1547); deudor debe probar diligencia
La víctima debe probarla (regla general)

Prescripción
5 años (art. 2515)
4 años desde el hecho (art. 2332)

Solidaridad
No se presume; solo por convención o ley (art. 1511)
Opera de pleno derecho (art. 2317)

Graduación de culpa
Grave, leve, levísima (art. 44)
Solo culpa leve como referencia

Daño moral
Debatido; mayoría lo admite actualmente
Plenamente reconocido (art. 2329)

Capacidad
Reglas generales (art. 1446 y ss.)
Reglas propias: incapaces 

Mora
Requiere interpelación (art. 1551)
No se requiere; la obligación nace con el hecho
...
La posición contraria, que BARROS considera más correcta, afirma que el régimen común es el extracontractual, porque se refiere precisamente a las relaciones no regidas por un vínculo obligatorio preexistente, que son la regla en el tráfico espontáneo entre personas que no tienen un contrato previo. El contrato supone necesariamente un acuerdo anticipado, que no existe en la gran mayoría de los encuentros entre personas en la vida social. Por ello, en la práctica, el estatuto que opera como régimen residual es el extracontractual.
...
La dimensión subjetiva del hecho voluntario exige que la conducta —acción u omisión— sea atribuible a su autor como acto libre. La responsabilidad civil ha reducido al mínimo las exigencias de subjetividad: basta que el agente haya tenido control sobre su conducta para que esta pueda serle imputada. No se requiere, como en el derecho penal, un juicio profundo de reproche personal; no es necesario siquiera que el sujeto conozca los efectos de su conducta. Basta que la controle.
...
Capacidad penal: plena a los 18 años; régimen especial de responsabilidad penal adolescente entre los 14 y los 18 (Ley N.° 20.084).
...
Corte Suprema, 10 de octubre de 1985. Se resolvió que quien participó en un hecho delictuoso bajo el efecto del alcohol mezclado subrepticiamente por un co-reo con alcaloides y anfetaminas debe considerarse que "participó en el robo privado parcialmente de razón por causas independientes de su voluntad". Si la pérdida de discernimiento no fue voluntaria, el agente puede alegar la inimputabilidad; la responsabilidad recae entonces sobre quien lo colocó en ese estado.
...
La doctrina discute cuál es el elemento de la responsabilidad sobre el que actúa el caso fortuito: algunos lo ubican como causal de exclusión de la culpa, otros de la causalidad. Siguiendo a CORRAL —y en esto concuerda BOETSCH— lo más apropiado es ubicarlo como causal de supresión de la voluntariedad del hecho: cuando un daño se produce por caso fortuito, en rigor no puede ser vinculado a una voluntad humana, pues es el evento externo e irresistible el que determina el resultado dañoso, no la conducta del agente.
...
Jurisprudencia — Responsabilidad civil extracontractual de personas jurídicas
...
Jurisprudencia — Precedente médico fundacional: CS, 20 de enero de 2011, Rol N.° 2074-2009
...
Jurisprudencia — Pérdida de chance: CS, 6 de enero de 2025, Rol N.° 242.342-2023

Corte Suprema, 6 de enero de 2025 (Rol N.° 242.342-2023). En este fallo, la Corte conoció de la demanda deducida por Alpes Chemie S.A. en contra de CENABAST, fundada en que el organismo público rebajó arbitraria e ilegalmente el puntaje de la demandante en una licitación pública de Inmunoglobulina G humana, lo que fue declarado ilegal por el Tribunal de Contratación Pública.
...
La Corte Suprema ha señalado que el daño moral "es la lesión efectuada culpable o dolosamente, que significa molestias en la seguridad personal del afectado, en el goce de sus bienes o en un agravio a sus afecciones legítimas, de un derecho subjetivo de carácter inmaterial e inherente a la persona e imputable a otra. Daño que sin duda no es de naturaleza propiamente económica y no implica, por lo tanto, un deterioro o menoscabo real en el patrimonio de la misma, susceptible de prueba y determinación directa; sino que posee una naturaleza eminentemente subjetiva."
...
Daño moral de las personas jurídicas. La jurisprudencia chilena ha oscilado en esta materia. El criterio predominante, afirmado por la Corte Suprema desde 2003, es que las personas jurídicas solo pueden reclamar daño extrapatrimonial cuando el menoscabo —aunque de naturaleza inmaterial— tiene consecuencias en el patrimonio de la entidad, como la reducción de clientela o la pérdida de capacidad crediticia derivadas del desprestigio. No procede, en cambio, la indemnización de un daño moral "puro" —sin repercusión patrimonial— para las personas jurídicas, pues estas no pueden sentir ni sufrir en el sentido propio del término.
...
5.2.7. Avaluación del daño moral

La avaluación del daño moral es una de las cuestiones más controvertidas del sistema de responsabilidad. Los tribunales enfrentan la dificultad de traducir un concepto intangible a una cifra monetaria, sin que existan parámetros objetivos precisos.
...
Valor normativo. La jerarquía del principio no es una cuestión ociosa: si tuviera rango constitucional, operaría como un límite al legislador; si solo tuviera el valor de una ley común, sería plenamente disponible y aun derogable. DOMÍNGUEZ HIDALGO precisa que, en Chile, ninguna Corte le ha reconocido derechamente rango constitucional; pero tanto la Corte Suprema como el Tribunal Constitucional lo han fundado en los artículos 19 N.° 1 (integridad física y psíquica) y N.° 24 (propiedad) de la Constitución, y se ve reforzado por el artículo 1, que pone al Estado al servicio de la persona humana. La conclusión de la autora es matizada: el principio no está incorporado por la Constitución —no tiene rango constitucional—, pero sí reforzado por ella, pues integra el ordenamiento jurídico desde la recepción del alterum non laedere. Esta precisión es, además, la base de su tesis de que el artículo 2331 se encuentra «virtualmente derogado» por la Constitución (véase 5.2.5).
...
Establecer los hechos que pueden constituir culpa (si hubo choque, si existía un disco "Pare", la velocidad del conductor) es atribución privativa de los jueces del fondo. Pero calificar esos hechos —decidir si constituyen culpa, dolo o caso fortuito— es cuestión de derecho, pues se trata de conceptos definidos por la ley (art. 44). Por ello, la doctrina nacional sostiene unánimemente que el juicio de culpabilidad es revisable por la Corte Suprema mediante casación en el fondo. Distíngase de la avaluación del daño (5.2.7), que es cuestión de hecho no revisable.
...
El estado de necesidad se diferencia del caso fortuito en que el hecho, aunque imprevisto, no es irresistible: puede resistirse, pero a costa de un daño propio. Nuestra legislación civil no lo contempla expresamente (sí lo hace el art. 10 N.° 7 del Código Penal), por lo que su acogida exige asimilarlo a la ausencia de culpa. Su efecto es excluir la acción indemnizatoria de la víctima, pero no la acción restitutoria: como advierte RODRÍGUEZ GREZ, el derecho no puede amparar el enriquecimiento injusto de quien salva un bien propio con cargo a un patrimonio ajeno, de modo que subsiste el deber de compensar los daños materiales necesarios para restaurar el equilibrio entre ambos patrimonios.
...
Provecho del dolo ajeno (art. 2316 inc. 2.°). Quien recibe provecho del dolo ajeno, sin ser cómplice, responde hasta la concurrencia de ese provecho. RODRÍGUEZ GREZ precisa que aquí la responsabilidad objetiva no se funda en el riesgo, sino en la reparación del enriquecimiento injusto.

Estatutos especiales. Las principales leyes que consagran fórmulas de responsabilidad objetiva en Chile son: la Ley N.° 18.302 sobre Seguridad Nuclear (responsabilidad del explotador por todo "accidente nuclear", canalizada exclusivamente en él y sujeta a límites de cuantía); el Decreto Ley N.° 2.222 (Ley de Navegación) y el convenio internacional sobre contaminación de las aguas por hidrocarburos; el Código Aeronáutico (daños a terceros en la superficie y a pasajeros); y la Ley N.° 18.290 del Tránsito (responsabilidad del propietario del vehículo). A ellos suele añadirse la responsabilidad por daño ambiental y otros regímenes sectoriales. En todos, el legislador ha preferido garantizar la reparación de la víctima frente a actividades intrínsecamente riesgosas, desplazando la exigencia de culpa.
...
DOMÍNGUEZ HIDALGO afina la terminología y propone abandonar derechamente la voz «cúmulo». Cúmulo significa suma, y lo que el derecho chileno prohíbe es que la víctima ejerza dos acciones y obtenga dos reparaciones por un mismo perjuicio, para evitar el enriquecimiento sin causa. La concurrencia, en cambio, designa una construcción diversa: la posibilidad de que la víctima acumule los aspectos más ventajosos de uno y otro estatuto —por ejemplo, la presunción de culpa propia del régimen contractual junto con la mayor extensión del daño indemnizable del extracontractual—, no para cobrar dos veces, sino para configurar una sola pretensión más favorable. De ahí que la denominación correcta sea concurrencia o concurso de responsabilidades, y no cúmulo.

¿Cuándo hay verdadera concurrencia? No todo daño ocurrido entre partes ligadas por un contrato plantea el problema. DOMÍNGUEZ HIDALGO ofrece cuatro reglas de delimitación:

No hay concurrencia cuando el contrato fue solo la ocasión del daño. Si el perjuicio no proviene del incumplimiento de un deber contractual, sino de actos externos al contrato producidos «con ocasión» de él, la existencia del vínculo no basta para calificar el daño como contractual. La precisión es especialmente relevante para el daño moral, que a menudo se produce al margen de los deberes propiamente pactados.

No hay concurrencia cuando el daño recae en bienes o intereses de terceros. Las reglas contractuales solo reparan los perjuicios producidos entre los cocontratantes; si el incumplimiento daña a un tercero, se aplican sin más las reglas extracontractuales.

Sí hay concurrencia cuando el daño del incumplimiento es, a la vez, un ilícito extracontractual. Son los casos fronterizos en que un mismo hecho admite ambos conjuntos de reglas: típicamente, los daños de la culpa in contrahendo (la mal llamada responsabilidad precontractual) o postcontractual, y los producidos en bienes de la persona —vida, integridad, salud— en los contratos de transporte, de trabajo o de prestación de servicios médicos, donde el daño moral suele calificarse de fronterizo.

La concurrencia supone siempre un beneficio para la víctima. Solo la hay cuando, al excluir el régimen contractual naturalmente aplicable, la víctima mejora su posición; de lo contrario, la discusión carece de objeto práctico.
...
===== MANUAL: RESPONSABILIDAD PRECONTRACTUAL =====
...
Eje 1. Planteamiento del problema y concepto de responsabilidad precontractual

Eje 2. Evolución doctrinaria: de la doctrina tradicional a la doctrina moderna

Eje 3. Las etapas del proceso de formación del contrato

Eje 4. El interés jurídicamente protegido y el fundamento de la buena fe

Eje 5. Naturaleza jurídica de la responsabilidad precontractual

Eje 6. Determinación de los daños a resarcir

Eje 7. Los requisitos para que nazca el derecho a la reparación y su aplicación jurisprudencial

Eje 8. La responsabilidad de quien causa la nulidad del contrato

Eje 9. La responsabilidad postcontractual

Eje 10. Derecho comparado y síntesis general de la materia
...
1.1. El concepto de responsabilidad precontractual
...
Distinción fundamental: qué NO protege la responsabilidad precontractual
...
Dato de grado: las cuatro preguntas de Orrego, esqueleto de todo el examen
...
1.3. Las dos grandes etapas del período precontractual
...
2.1. La doctrina tradicional: las tres fases y el silencio hasta la oferta
...
2.2. La irrupción de Ihering: la culpa in contrahendo
...
Ejemplo: el caso de las libras y los quintales
...
2.3. Faggella: de la oferta hacia los tratos previos
...
2.5. La síntesis de la doctrina moderna: tres requisitos comunes

Dato de grado: Ihering, Faggella y Saleilles en un cuadro

AutorMomento en que puede nacerFundamentoDaño resarcible

Ihering (1860)Solo desde la ofertaCulpa contractual (culpa in contrahendo)Interés negativo, sin distinguir con claridad si incluye lucro cesante

Faggella (1906)Desde los tratos previos (antes de la oferta)Transgresión del acuerdo tácito de negociar, sin necesidad de dolo ni culpaSolo gastos reales (daño emergente); nunca lucro cesante

Saleilles (1907)Desde los tratos previosInfracción a los usos y la equidad comercial (estándar objetivo)Gastos si no hubo oferta; cumplimiento posible si hubo oferta con plazo revocada antes de tiempo

De la convergencia entre Ihering, Faggella y Saleilles (pese a sus diferencias de fundamento) la doctrina moderna extrae tres requisitos comunes para que exista responsabilidad precontractual: que haya existido un acuerdo de entablar negociaciones con miras a la celebración de un contrato; que el retiro de las negociaciones por una de las partes sea arbitrario, es decir, que carezca de fundamento jurídico; y que ese retiro haya causado perjuicio a la otra parte. Estos tres requisitos, formulados aquí en su versión más general, reaparecerán, con matices propios de cada autor, en el Eje 7, dedicado específicamente a los requisitos de la responsabilidad precontractual en el derecho chileno.
...
2.6. Análisis de la tensión: culpa, ruptura del acuerdo y equidad comercial
...
2.7. Síntesis para estructurar la respuesta de examen
...
Eje 3. Las etapas del proceso de formación del contrato y el estatuto de responsabilidad aplicable en cada una
...
Advertencia: no confundir formación progresiva con ejecución progresiva
...
3.1. Los tratos negociales previos o negociaciones preliminares
...
Distinción fundamental: cierre de negocio vs. arras
...
EtapaEstatuto aplicableFundamento

Tratos negociales previosExtracontractual (salvo convención que regule las tratativas)No hay vínculo jurídico entre las partes

OfertaExtracontractual (retractación intempestiva no avisada) o legal (retractación tempestiva con daño)Arts. 98 y 100 C. de Comercio

Cierre de negocioDiscutido: cuasicontractual (Rosende), contractual condicionado/extracontractual (Corral), contrato innominado (Puelma/Abeliuk)No hay acuerdo doctrinario sobre si existe convención

Contrato preparatorioContractual, sin discusiónYa existe un contrato válidamente celebrado (ej. promesa, art. 1554)

Contrato definitivoContractual, fuera del ámbito precontractualEl proceso de formación ya concluyó

3.6. Análisis de la tensión: un itinerario de vinculación creciente y de estatutos cambiantes
...
3.7. Síntesis para estructurar la respuesta de examen
...
4.1. El interés jurídicamente protegido
...
Distinción fundamental: qué protege la responsabilidad precontractual

NO protege el interés en que el contrato se celebre (las partes siempre son libres de no contratar). SÍ protege el interés en participar correcta y lealmente en el proceso de negociación. Confundir ambos interés es el error más común al plantear un caso: nadie responde por negarse a contratar, se responde por la forma en que se condujo mientras negociaba.

4.2. La buena fe como fundamento común

De los Mozos, citando a Castán Tobeñas, formula la idea matriz que preside todo este eje: en la base misma de la formación de todo contrato existe ya, para las partes, un deber de lealtad recíproca y buena fe. Por regla general, la ruptura de los tratos no acarreará ninguna responsabilidad; pero si, llegadas las conversaciones a un punto en que podía razonablemente esperarse la conclusión del contrato, una de las partes se retracta sin motivo justificado, queda obligada a responder ante la otra, por su proceder arbitrario, de los gastos realizados y de las pérdidas patrimoniales sufridas.
...
4.3. El catálogo de conductas conformes a la buena fe
...
Dato de grado: el catálogo de conductas de buena fe (Saavedra)
...
4.4. Análisis de la tensión: buena fe como estándar objetivo frente al riesgo de desincentivar la negociación
...
4.5. Síntesis para estructurar la respuesta de examen
...
5.1. La tesis contractualista: Ihering
...
5.2. La posición de Alessandri: un distingo según el momento
...
5.3. Otros fundamentos minoritarios: el abuso del derecho, la ley, la declaración unilateral de voluntad
...
5.4. La tesis extracontractual: posición mayoritaria en Chile
...
Ejemplo: Buenos Aires y Tucumán (Brebbia)
...
Para ilustrar esta diferencia de grado, Brebbia contrasta dos situaciones aparentemente similares: si A invita a B a conversar sobre un negocio en perspectiva, y en cumplimiento de esa invitación B realiza gastos previsibles para A, este debe responder de esos gastos si, antes de reunirse con B, cierra el mismo negocio con otra persona; pero si A simplemente invita a B a viajar para conversar en general, sin entrar todavía en tratativas de un negocio concreto, A no responde civilmente de los gastos del viaje.
...
Dato de grado: las cinco tesis sobre naturaleza jurídica

TesisAutoresPunto débil

Contractual (culpa in contrahendo)Ihering, Alessandri (solo tras la oferta)No puede haber responsabilidad contractual sin contrato

Abuso del derechoRipert, Josserand, PicassoDurante las tratativas las partes no tienen aún un derecho propiamente tal que ejercer abusivamente

Responsabilidad legal(minoritaria, aplicada a arts. 99-100 C. de Comercio)No explica por qué la ley lo impone, solo constata que lo hace

Declaración unilateral de voluntadBoffi (para la oferta que por sí sola obliga, art. 99 C. de Comercio)Solo cubre el caso puntual del oferente que se comprometió a un plazo

Extracontractual (mayoritaria en Chile)De los Mozos, Brebbia, SaavedraDebe explicar por qué la culpa precontractual no es la misma culpa aquiliana ordinaria entre extraños

5.5. Análisis de la tensión: cinco fundamentos para un mismo problema
...
5.6. Síntesis para estructurar la respuesta de examen
...
Eje 6. Determinación de los daños a resarcir en la responsabilidad precontractual
...
6.1. La distinción de Ihering: interés positivo e interés negativo
...
Dato de grado: Cuadro comparativo: interés positivo vs. interés negativo

AspectoInterés positivo (de cumplimiento)Interés negativo (de confianza)

Qué reparaLo que se habría obtenido si el contrato se hubiera cumplidoEl daño de haber confiado en la celebración o validez del contrato

PresuponeUn contrato válido y efectivamente incumplidoUn contrato que nunca nació o que nació nulo

ÁmbitoIncumplimiento contractual ordinario (ajeno a este manual)Responsabilidad precontractual propiamente tal

Partidas típicasLucro cesante del negocio frustradoDaño emergente (gastos); lucro cesante solo tras la oferta, según Brebbia

Posición dominante en ChileNo aplica en sede precontractualRestrictiva: solo daño emergente (León Hurtado, Rosende)

6.2. La posición restrictiva: Faggella, Saleilles y la doctrina chilena tradicional
...
6.3. La posición integral con límite causal: Brebbia
...
Respecto del daño originado durante la etapa de las tratativas preliminares (antes de la oferta), el damnificado solo puede demandar el reembolso de los gastos ocasionados por las negociaciones, no la ganancia dejada de percibir, porque entre esta última y el hecho culposo no existe, según Brebbia, una relación de causalidad adecuada: la privación de la hipotética ganancia no tiene por causa la ruptura culpable de las tratativas, sino la propia decisión del damnificado de comprometerse en negociaciones con una persona determinada, desechando con ello otras perspectivas que pudieron ofrecerle una seguridad mayor de concluir el contrato. En otras palabras, el lucro cesante derivado de negociaciones alternativas no realizadas es, para Brebbia, una consecuencia demasiado remota y contingente del hecho de la contraparte como para imputársela con el rigor causal que la responsabilidad civil exige.
...
6.4. Análisis de la tensión: dos criterios distintos para limitar el resarcimiento
...
6.5. Síntesis para estructurar la respuesta de examen
...
Pausa: Comprensión lectora
Has terminado el Eje 6: Determinación de los daños a resarcir en la responsabilidad precontractual. Antes de avanzar, entra a la plataforma Digesto y responde las preguntas de comprensión lectora de esta sección: te servirán de check-in de lo leído hasta aquí. Si alguna se te resiste, vuelve sobre el apartado antes de seguir.
...
7.1. Los siete requisitos de Saavedra
...
7.2. Los cuatro requisitos de Celis
...
Segundo, que los gastos en que incurrió una de las partes se hayan ocasionado a consecuencia de la conducta desplegada por la otra parte, que después se retira de la negociación; Celis ilustra este requisito con un ejemplo revelador: si una empresa llama a arquitectos para realizar estudios sobre una construcción, sin advertirles previamente que esos estudios no generarán compromiso alguno para la empresa, los gastos en que incurran los arquitectos quedan conectados causalmente con la conducta de quien los convocó.
...
Dato de grado: tres catálogos de requisitos, un mismo terreno

SaavedraCelisTribunal, caso Lavín con Mena

Negociaciones tendientes a un acuerdo no perfeccionado (o nulo)Conversaciones voluntarias, sin obligación previaConsentimiento en negociar

Conducta antijurídica que frustra el objetivo contractualGastos ocasionados por la conducta de la contraparteGastos incurridos con miras al contrato

Conducta reprochable e imputable a un partícipePonderación de riesgos ordinarios del negocioRetiro unilateral injustificado

Culpa por transgresión de la buena feRetiro unilateral de las negociacionesInfracción a la buena fe (culpa o dolo)
...
7.3. El caso Lavín con Mena: hechos
...
La ejecución de lo acordado, sin embargo, se frustró en los pasos siguientes. El 6 de julio de 2022, se envió al vendedor un borrador de promesa de compraventa que contenía condiciones distintas de las contempladas en la oferta original y ya aceptada: el plazo para la firma de la promesa y del contrato definitivo, y para el pago del precio, se modificó de seis meses a ciento ochenta días hábiles (una extensión encubierta del plazo), se estableció que el pago se verificaría contra la inscripción del inmueble, y se introdujo la calificación de que el nuevo plazo no sería extintivo.
...
El vendedor demandó entonces la indemnización de perjuicios bajo el régimen de responsabilidad civil precontractual, solicitando el cobro de la cláusula penal equivalente al diez por ciento del precio pactado, que las partes habían fijado como avaluación anticipada de los perjuicios derivados del incumplimiento.
...
7.4. El caso Lavín con Mena: el marco doctrinario que el tribunal aplica
...
7.5. El caso Lavín con Mena: la decisión
...
7.7. Síntesis para estructurar la respuesta de examen
...
8.1. El origen histórico del problema: Ihering y los textos romanos
...
8.2. La dificultad de fondo: ni contrato válido ni completa extrañeza
...
8.3. La posición de Rodríguez Grez: responsabilidad legal
...
8.4. La posición extracontractual: Baraona y la mayoría de la doctrina nacional
...
Esta posición es coherente con la tesis extracontractual mayoritaria examinada con detalle en el Eje 5 para la responsabilidad precontractual en sentido estricto, y no es casualidad: ambas hipótesis (la ruptura de negociaciones y la nulidad del contrato) comparten, en definitiva, la misma estructura de fondo, según se explicitará en el análisis de la tensión de este eje.

8.5. Boffi y el derecho comparado: la responsabilidad aquiliana en el derecho argentino
...
Boffi se apoya en el artículo 1056 del Código Civil argentino, conforme al cual los actos anulados, aunque no produzcan los efectos de los actos jurídicos, producen sin embargo los efectos de los actos ilícitos, cuyas consecuencias deben repararse; concluye entonces que un acto con pretensiones de jurídico, aunque no llegue a serlo por habérsele aplicado la sanción anulatoria, puede dar lugar a otras sanciones, como la indemnización, en virtud de constituir, además de un acto jurídico frustrado, un acto ilícito: la responsabilidad sería, en consecuencia, aquiliana, lo que presupone la existencia de dolo o culpa.
...
Dato de grado: tres posiciones sobre la responsabilidad por nulidad

PosiciónAutorFundamento

Responsabilidad legalRodríguez GrezNace directamente de la ley, presupone culpa o dolo (ejemplo: causales de indemnización en nulidad matrimonial)

Responsabilidad extracontractualBaraona (mayoritaria en Chile)Culpa cualificada por buena/mala fe y expectativas de confianza; en lo demás, extracontractual ordinaria

Responsabilidad aquiliana (comparado)Boffi (derecho argentino)Art. 1056 CC argentino: el acto anulado produce efectos de acto ilícito. Equivalente chileno: art. 1687 CC (restitución al estado anterior)

8.6. Análisis de la tensión: por qué la nulidad no rompe, sino que confirma, la lógica extracontractual
...
La aparente cercanía contractual del supuesto (hubo, en los hechos, un consentimiento prestado) resulta ser, entonces, engañosa: lo único que realmente queda, una vez declarada la nulidad, es la conducta de quien conocía o debía conocer el vicio y no lo reveló, conducta que es estructuralmente idéntica a la que se examina en la ruptura de negociaciones (el ocultamiento de información relevante, la infracción del deber de lealtad negocial ya examinado en el Eje 4).
...
8.7. Síntesis para estructurar la respuesta de examen
...
Ejemplo: el trabajador que revela información reservada
...
9.1. La tesis de la proyección contractual
...
9.2. La tesis extracontractual: la posición de Corral
...
Dato de grado: la salvedad de Corral
...
9.3. Análisis de la tensión: la supervivencia de los deberes de lealtad más allá del contrato
...
9.4. Síntesis para estructurar la respuesta de examen
...
Eje 10. La responsabilidad precontractual en el derecho comparado y síntesis general de la materia
...
10.1. El Código Civil italiano: la cláusula general de buena fe
...
10.2. El Código Civil portugués
...
10.3. El Anteproyecto de Código europeo de contratos
...
10.4. El Código Civil alemán

El Código Civil alemán (BGB) recoge, según se anticipó en el Eje 2, solo una recepción parcial de la doctrina de Ihering, dispersa en varios parágrafos que regulan supuestos específicos antes que un principio general de responsabilidad precontractual. El parágrafo 122 dispone la reparación de daños y perjuicios en los casos de declaraciones de voluntad nulas por falta de seriedad o por error, indemnizando el daño sufrido por haber confiado en la validez del contrato (recepción directa, y bastante fiel, del interés negativo de Ihering examinado en el Eje 6).

El parágrafo 179 regula el caso del contrato celebrado por el falsus procurator, quien carece de poder de representación, cuando la otra parte desconocía esa falta de poder. Y los parágrafos 307 y 309 se refieren al contrato nulo por imposibilidad originaria de la prestación, sea por ser esta contraria a una prohibición legal, sea por ser contraria a las buenas costumbres.
...
OrdenamientoNormaTécnica

Italia (1942)Arts. 1337 (buena fe general) y 1338 (nulidad)Cláusula general de buena fe, separada de la nulidad

Portugal (1966)Art. 227Cláusula general de buena fe, sin distinguir tratos de formación

Anteproyecto de PavíaArts. 6 y 7Cláusula general de buena fe + gradación según etapa + deber de información

Alemania (BGB)§§ 122, 179, 307, 309Supuestos específicos y fragmentarios, sin cláusula general

10.5. Análisis de la tensión: dos técnicas legislativas frente a la construcción doctrinaria chilena
...
10.6. Síntesis general de la materia
